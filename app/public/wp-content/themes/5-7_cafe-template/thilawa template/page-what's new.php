...
<div class="header-image">
  ...
  <h1 class="font-serif">What's New</h1>
</div>
  ...
  <ul class="news-list column-center">
    ...
    ?>
      <li class="news-list-item">The article you were looking for was not found</li>
    <?php endif; ?>
  </ul>
</article>
  ...
  <nav class="posts-navigation">
    <div class="nav-links">
      ...
      if(get_query_var('paged') > 0):
        echo '<div class="nav-first"><a href="/news/">To the beginning</a></div>';
      else:
      ...
      if(get_query_var('paged') < $max_page && $max_page != 1):
        echo '<div class="nav-last"><a href="/news/page/'.$max_page.'/">To the end</a></div>';
      else:
